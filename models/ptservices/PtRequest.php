...
use Yii;
use app\modules\proficiencytesting\models\PtSample;
 ...
 */
class PtRequest extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['company_name', 'address_1','postal_code', 'country', 'mode_of_payment', 'name', 'position', 'delivery_address', 'date_inquiry'], 'safe'],
            [[ 'validated','id'], 'integer'],
            [['date_inquiry','address_2'], 'safe'],
            ...
            [['tel_no', 'mode_of_payment', 	'transaction_number'], 'string', 'max' => 100],
        ];
    }
