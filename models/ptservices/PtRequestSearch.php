...
/**
 * PtRequestSearch represents the model behind the search form of `app\modules\proficiencytesting\models\PtRequest`.
 */
class PtRequestSearch extends PtRequest
{
    /**
     * {@inheritdoc}
     */
