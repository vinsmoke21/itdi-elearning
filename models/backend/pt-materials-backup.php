...
// use app\modules\proficiencytesting\models\Section;
...
class Pt_materials extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['analyte_matrix','concentration_range','fee','section_id'], 'required'],
            [['pt_code'], 'safe'],
    ...
    public function getAvpOrderedBySection()
    {
        return Avp::find()
            ->orderBy('section_id')
            ->all();
    ...
    {
        return $this->hasOne(Pt_materials::className(), ['id' => 'section_id']);
    }
}
