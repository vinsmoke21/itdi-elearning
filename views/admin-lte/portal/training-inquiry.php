        ...
        <div style="padding: 10px 20px">
          <div class="row">
            <div class="col-md-6">
              ...
              <?=
                $form->field($webinar_inquiry, 'name')->textInput(['placeholder' => 'Full Name'])
              ?>
            </div>
            <div class="col-md-6">
              <?=
                $form->field($webinar_inquiry, 'contactnum')->textInput(['placeholder' => 'Input Contact Number',  'pattern' => '\d*'])
              ?>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <?=
                $form->field($webinar_inquiry, 'nop')->textInput(['placeholder' => 'Input Number of Participants', 'pattern' => '\d*'])
              ?>
            </div>

            <div class="col-md-6 test">
              <?= $form->field($webinar_inquiry, 'mop')->dropDownList(
                ['Cash' => 'Cash', 'Check' => 'Check', 'E-payment' => 'E-payment', 
          ...
          <div class="row">
            <div class="col-md-6">
              <?= $form->field($webinar_inquiry, 'receiver_email')->textInput(['placeholder' => '@gmail.com']) ?>
            </div>
            <div class="col-md-6">
              <?=
                $form->field($webinar_inquiry, 'address')->textArea()
              ?>
            </div>
          </div>
