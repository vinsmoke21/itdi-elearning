  ...
  <div class="customer-form">
      ...
      <div style="padding: 10px 20px">
        <div class="row" style="padding-bottom: 10px;">
          <div class="col-md-6">
            ...
            <?= $form->field($webinar_inquiry, 'name',['options'=>['class' => 'has-float-label'],
                  'labelOptions' => ['class' => ''],
                  'template' =>'{input}{label}{error}{hint}',
                  ],)->textInput(['maxlength' => true, 'placeholder' => 'Full Name'])?>
          </div>
          <div class="col-md-6">
          <?= $form->field($webinar_inquiry, 'contactnum',['options'=>['class' => 'has-float-label'],
                  'labelOptions' => ['class' => ''],
                  'template' =>'{input}{label}{error}{hint}',
        ...
        <div class="row" style="padding-bottom: 10px;">
          <div class="col-md-6">
             <?= $form->field($webinar_inquiry, 'nop',['options'=>['class' => 'has-float-label'],
                  'labelOptions' => ['class' => ''],
                  'template' =>'{input}{label}{error}{hint}',
                  ],)->textInput(['maxlength' => true, 'placeholder' => 'Input Number of Participants', 'pattern' => '\d*'])?>
          </div>
          <div class="col-md-6">

              <?= $form->field($webinar_inquiry, 'mop',['options'=>['class' => 'has-float-label'],
                  'labelOptions' => ['class' => ''],
                  'template' =>'{input}{label}{error}{hint}',
        ...
        <div class="row">
          <div class="col-md-6">
          <?= $form->field($webinar_inquiry, 'receiver_email',['options'=>['class' => 'has-float-label'],
                  'labelOptions' => ['class' => ''],
                  'template' =>'{input}{label}{error}{hint}',
                  ],)->textInput(['maxlength' => true, 'placeholder' => '@gmail.com', 'type' => 'email'])?>
          </div>
          <div class="col-md-6">
          <?= $form->field($webinar_inquiry, 'address',['options'=>['class' => 'has-float-label'],
                  'labelOptions' => ['class' => ''],
                  'template' =>'{input}{label}{error}{hint}',
    ...
    <div class="row">
      <div class="col-md-12" role="tab" id="headingTwo">
        <h5 align="center">
          <input type="checkbox" id="service_check" onclick="window.open('https://itdi.dost.gov.ph/images/TransparencySeal/DPA/Data-Privacy-Notice.pdf?fbclid=IwAR0DKLTkfabhTvIqWKkwvVbGVmld1jlEGexLn0vWERTw6CD40nqdhWhwBto', '_blank')"/>
          <label for="service_check" >
            By checking this box, you agree to the Data Privacy Policy and
