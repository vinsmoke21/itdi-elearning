          ...
          <div class="single-products">
            ...
            <div class="choose" style="margin-top: -20px; padding-left:10px">
              ...
              <ul class="nav nav-pills" style="margin-top: 5px;">
                ...
                <div class="slider">
                  <?php
                  $externals = ExternalSpeaker::find()->where(['training_id' => $semandtrain['id']])->one();
                  $internals = InternalSpeaker::find()->where(['training_id' => $semandtrain['id']])->one();
                  $externalSem = ExternalSpeaker::find()->where(['seminar_id' => $semandtrain['id']])->one();
                  $internalSem = InternalSpeaker::find()->where(['seminar_id' => $semandtrain['id']])->one();
                  ...
                  if ($externals != null) : ?> 
                    <div class="user">
                      <img src="<?= Yii::getAlias('@speakerUrl') . '/' . $externals->speak->profile ?>" />
                      <div class="user-info" style="margin-top: 5px;">
                        <h5><span class="pull-left"><?= $externals->speak->speaker ?></span></h5>
                        <small><span class="pull-left"><?= $externals->external->designation ?> </span></small>
                      </div>
                    </div>
                  <?php endif; ?>
