...
<div class="col-lg-12">
    <p class="title-caption" style="margin-top: 70px;"><h2 style="color:#fff">Reference Materials</h2></p>
    <div class="panel panel-success" style="background-color: #d1d8e0;"> 
      <div class="panel-heading" style="background-color: tranparent;">
      <center><b>List of Available Matrix CRMs</b> <p>(as of December 2021)</p></center>
      </div>
            
          <div class="table-responsive">
              <table class="kv-grid-table table  table-striped kv-table-wrap">
                
                  <thead class="table-bordered" style="color: #fff; background-color: #004d7a;">
                      <tr>
                          ...
                          <th class="table-bordered" style="text-align:center">Certificate of Analysis</th>
                          <th class="table-bordered" style="text-align:center">Buy</th>
                      </tr>
                      <tr style="background-color:#a4b0be">
                        <th></th>
                        <th></th>
                        <th style="text-align: full-left; color:black;">Water Matrix</th>
                        <th></th>
                        <th></th>
                        <th></th>
                      </tr>
                      ...
                      <tbody>
                        ...
                        <tr style="text-align: center;">
                          ...
                          <td class="table-bordered"><a onclick="window.open('file:///C:/xampp/htdocs/cportal/itdi-elearning/views/admin-lte/pt-services/TAC-2021-003-Assessment-Report.pdf/','_blank');">
                            <button class="btn btn-success">
                                <i class="fa fa-download"></i> Download
                            </button>
                          </a></td>
                          <td class="table-bordered">
                            <a href="<?= Yii::$app->request->baseUrl?>/service/create" class="btn btn-primary">Buy</a>
                          </td>
                      </tr>
                    ...
                    <tr style="text-align: center;">
                      ...
                      <td class="table-bordered"> <button class="btn btn-success">
                                                      <i class="fa fa-download"></i> Download
                                                  </button></td>
                      <td class="table-bordered"><button class="btn btn-primary">
                    ...
                    <tr  style="background-color: #a4b0be">
                        <th></th>
                        <th></th>
                        <th style="text-align: full-left; color:black;">Food Matrix</th>
                        <th></th>
                        <th></th>
                        <th></th>
                      </tr>
                  ...
                  <tbody>
                    ...
                    <tfoot>
                        <tr>
                        <th colspan="6" style="color: white; background-color: #051937;">                            
